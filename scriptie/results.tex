...
%TODO \mijnfiguur{width=0.55\textwidth}{CVscheme}{Cross validation}


The next section will only focus on the RF feature selection method, as this method is a proven method in literature \citep{rfPaper}. Random forest themselves are known to be robust against noise. Additionally the method is able to detect groups of features that perform well, as explained in Section \ref{rfexpl}.

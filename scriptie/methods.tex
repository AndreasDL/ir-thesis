...
The following table gives an overview of the different features and the amount of them used. The 32 EEG channels can be found in Table \ref{DEAPSignals}. There are 6 frequency bands: Alpha, Beta, Gamma, Delta, Theta and All. All refers to taking the total power of a channel. Note that the fractions only have 5 frequency bands, as the percentage of all power would always be 100$%$. 
...
The feature set has a size of 894, which is huge considering that there are only 40 samples for each person. %TODO
